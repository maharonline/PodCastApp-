...
import { View, Text, StyleSheet, TouchableOpacity, Image, ScrollView, TextInput, KeyboardAvoidingView, Platform, Alert, ActivityIndicator, ToastAndroid } from "react-native";
                ...
                <ScrollView contentContainerStyle={{ flexGrow: 1 }} keyboardShouldPersistTaps="handled">
                    <View style={styles.container}>
                        ...
                        <View style={styles.card}>
                            ...
                            {step === 'verify' && (
                                <>
                                    <Text style={styles.infoText}>Enter the OTP sent to {email}</Text>

                                    {/*======= OTP Input ======== */}
                                    <View style={styles.inputBox}>
                                        <FontAwesome6 name="key" size={20} color="#000" style={{ marginRight: 10 }} />
                                        <TextInput
                                            style={styles.input}
                                    ...
                                    <TouchableOpacity onPress={() => setStep('email')}>
                                        <Text style={styles.registerText}>
                                            Didn't receive OTP? <Text style={styles.registerLink}>Resend</Text>
                                        </Text>
                                    </TouchableOpacity>
                                </>
                            )}
                            ...
                            <TouchableOpacity onPress={() => navigation.goBack()}>
                                <Text style={styles.registerText}>
                                    Remember your password? <Text style={styles.registerLink}>Sign in</Text>
                                </Text>
                            </TouchableOpacity>
                        </View>
                    </View>
