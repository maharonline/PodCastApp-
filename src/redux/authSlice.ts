...
//   initialState,
//   reducers: {
//     setLoggedIn: (state, action: PayloadAction<User>) => { state.user = action.payload; state.isAuthenticated = true; },
//     setLoggedOut: (state) => { state.user = null; state.isAuthenticated = false; },
//     toggleTheme: (state) => { state.theme = state.theme === "light" ? "dark" : "light"; },
//   },
//   extraReducers: builder => {
//     builder.addCase(fetchUser.pending, (state) => { state.loading = true; });
//     builder.addCase(fetchUser.fulfilled, (state, action: PayloadAction<User | null>) => { state.user = action.payload; state.isAuthenticated = !!action.payload; state.loading = false; });
//     builder.addCase(fetchUser.rejected, (state) => { state.user = null; state.isAuthenticated = false; state.loading = false; });
//   }
// });
